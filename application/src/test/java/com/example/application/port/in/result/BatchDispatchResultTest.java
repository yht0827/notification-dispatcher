...
class BatchDispatchResultTest {
	...
	void failure_defaultsFailureTypeToRetryable() {
		BatchDispatchResult result = new BatchDispatchResult(1L, false, "temporary", null, 100L);
	...
	void failure_normalizesNonPositiveRetryDelay() {
		BatchDispatchResult result = BatchDispatchResult.failRetryable(1L, "temporary", 0L);
